...
summary(glm1)
female.prob <- predict(glm1, newdata = data.frame(Gender="Female"), type = "response")
male.prob <- predict(glm1, newdata = data.frame(Gender="Male"), type = "response")
female.prob
male.prob
...
legend(x="bottomright", legend=c("knn1.err", "knn7.err", "knn100.err", "lr1.err", "lr2.err", "bayes.error"), lty=c(1,1,1,1,1,2), col=c("red", "blue", "green", "orange", "purple", "gray"))
```
...
legend(x="bottomright", legend=c("knn1.ROC", "knn7.ROC", "knn100.ROC", "lr1.ROC", "lr2.ROC", "bayes.error"), lty=c(1,1,1,1,1,2), col=c("red", "blue", "green", "orange", "purple", "black"))
...
#From the result we can see that the KNN model(K=7) is the best one.#
```
