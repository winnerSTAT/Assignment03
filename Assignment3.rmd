...
legend(x=0, y=0.3, legend=c("knn1.err", "knn7.err", "knn100.err", "lr1.err", "lr2.err", "bayes.error"), lty=c(1,1,1,1,1,2), col=c("red", "blue", "green", "orange", "purple", "gray"))
```
...
legend(x=0.8, y=0.2, legend=c("knn1.ROC", "knn7.ROC", "knn100.ROC", "lr1.ROC", "lr2.ROC", "bayes.error"), lty=c(1,1,1,1,1,2), col=c("red", "blue", "green", "orange", "purple", "black"))
